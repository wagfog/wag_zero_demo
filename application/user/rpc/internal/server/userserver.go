...
import (
	...
	"github.com/wagfog/wag_zero_demo/application/user/rpc/internal/logic"
...
func (s *UserServer) FindById(ctx context.Context, in *service.FindByIdRequest) (*service.FindByIdrResponse, error) {
