...
type UserClient interface {
	...
	FindById(ctx context.Context, in *FindByIdRequest, opts ...grpc.CallOption) (*FindByIdrResponse, error)
...
func (c *userClient) FindById(ctx context.Context, in *FindByIdRequest, opts ...grpc.CallOption) (*FindByIdrResponse, error) {
	out := new(FindByIdrResponse)
...
type UserServer interface {
	...
	FindById(context.Context, *FindByIdRequest) (*FindByIdrResponse, error)
...
func (UnimplementedUserServer) FindById(context.Context, *FindByIdRequest) (*FindByIdrResponse, error) {
