...
type (
	...
	FindByIdrResponse    = service.FindByIdrResponse
...
func (m *defaultUser) FindById(ctx context.Context, in *FindByIdRequest, opts ...grpc.CallOption) (*FindByIdrResponse, error) {
	client := service.NewUserClient(m.cli.Conn())
